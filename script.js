...
class QuizGame {
    constructor() {
        this.config = {
            SUPABASE_URL: '###', // ضع رابط خادم Supabase الرئيسي هنا
            SUPABASE_KEY: '###', // ضع مفتاح الخادم الرئيسي هنا
            ...
            APP_KEY: 'MS_AbuQusay',
            QUESTIONS_URL: 'https://github.com/AbuQusayMS/AQ_0/blob/main/questions.json', // ضع رابط ملف الأسئلة هنا
